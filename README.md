...
import (
    _ "github.com/hisonsoft/grpc-gateway/v2/protoc-gen-grpc-gateway"
    _ "github.com/hisonsoft/grpc-gateway/v2/protoc-gen-openapiv2"
...
```sh
$ go install \
    github.com/hisonsoft/grpc-gateway/v2/protoc-gen-grpc-gateway \
    github.com/hisonsoft/grpc-gateway/v2/protoc-gen-openapiv2 \
...
5. Write an entrypoint for the HTTP reverse-proxy server
   ...
   import (
     ...
     "github.com/hisonsoft/grpc-gateway/v2/runtime"
